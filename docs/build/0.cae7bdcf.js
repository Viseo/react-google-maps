  ...
  "./node_modules/codemirror/lib/codemirror.js": function(e, t, n) {
    ...
    ;(r = function() {
          ...
          c || (m != l && m != s) || m++,
            (h =
              0 == m
                ...
                : m == t.text.length
                ? "before"
                : measureCharPrepared(e, i, m - (c ? 1 : 0)).bottom + a <= o ==
                  c
                ? "after"
                : "before")
      ...
      function updateHeightsInViewport(e) {
        for (
          ...
          if (!o.hidden) {
            ...
            if (
              (p > 0.005 || p < -0.005) &&
              (updateLineHeight(o.line, l), updateWidgetHeight(o.line), o.rest)
            )
      ...
      function CodeMirror(e, t) {
        ...
        for (var h = 0; h < je.length; ++h) je[h](r)
        endOperation(this),
          l &&
            t.lineWrapping &&
      ...
      function applyTextInput(e, t, n, r, o) {
        ...
        for (
          var d = e.curOp.updateInput, p = r.ranges.length - 1;
          p >= 0;
          p--
        ) {
          var h = r.ranges[p],
          ...
          h.empty() &&
            (n && n > 0
              ...
              ? (g = Pos(
                  g.line,
                  Math.min(getLine(i, g.line).text.length, g.ch + lst(l).length)
                ))
              : s &&
                Ve &&
                Ve.lineWise &&
          ...
          var m = {
            ...
            origin:
              o || (s ? "paste" : e.state.cutIncoming > a ? "cut" : "+input"),
          }
          makeChange(e.doc, m), signalLater(e, "inputRead", e, m)
        }
      ...
      function disableBrowserMagic(e, t, n, r) {
      ...
      ;(Ue.prototype.init = function(e) {
        ...
        e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
          ...
          j(e.scroller, "paste", function(t) {
            if (!eventInWidget(e, t) && !signalDOMEvent(r, t)) {
              if (!o.dispatchEvent)
      ...
      e.defineMode("javascript", function(t, n) {
        ...
        function statement(e, t) {
          return "var" == e
            ...
            ? ((m.marked = "keyword"),
              cont(pushlex("form", "class" == e ? e : t), className, poplex))
            : "variable" == e
            ? c && "declare" == t
              ...
              ? ((m.marked = "keyword"),
                "enum" == t
                  ? cont(enumdef)
                  : "type" == t
                  ? cont(typename, expect("operator"), typeexpr, expect(";"))
                  : cont(
                      pushlex("form"),
                      pattern,
                      expect("{"),
        ...
        function maybetype(e, t) {
          if (c) {
            if (":" == e || "in" == t) return cont(typeexpr)
        ...
        function typeexpr(e, t) {
          return "keyof" == t || "typeof" == t || "infer" == t
            ? ((m.marked = "keyword"),
              cont("typeof" == t ? expressionNoComma : typeexpr))
            : "variable" == e || "void" == t
            ...
            : "(" == e
            ? cont(commasep(typearg, ")"), maybeReturnType, afterType)
            : "<" == e
        ...
        function typeprop(e, t) {
          return "variable" == e || "keyword" == m.style
            ...
            ? cont(typeexpr)
            : "[" == e
            ? cont(expect("variable"), maybetype, expect("]"), typeprop)
            : "(" == e
            ? pass(functiondecl, typeprop)
            : void 0
        }
        ...
        function afterType(e, t) {
          return "<" == t
            ...
            ? cont(typeexpr)
            : "[" == e
            ? cont(typeexpr, expect("]"), afterType)
            : "extends" == t || "implements" == t
            ? ((m.marked = "keyword"), cont(typeexpr))
            : "?" == t
            ? cont(typeexpr, expect(":"), typeexpr)
            : void 0
        }
        ...
        function forspec(e, t) {
          return "await" == t
            ? cont(forspec)
            : "(" == e
            ? cont(pushlex(")"), forspec1, poplex)
            : void 0
        }
        function forspec1(e) {
          return "var" == e
            ? cont(vardef, forspec2)
            : "variable" == e
            ? cont(forspec2)
            : pass(forspec2)
        }
        function forspec2(e, t) {
          return ")" == e
            ...
            ? cont(forspec2)
            : "in" == t || "of" == t
            ? ((m.marked = "keyword"), cont(expression, forspec2))
            : pass(expression, forspec2)
        }
        ...
        function functiondecl(e, t) {
          return "*" == t
            ? ((m.marked = "keyword"), cont(functiondecl))
            : "variable" == e
            ? (register(t), cont(functiondecl))
            : "(" == e
            ? cont(
                pushcontext,
                pushlex(")"),
        ...
        function typename(e, t) {
          return "keyword" == e || "variable" == e
            ? ((m.marked = "type"), cont(typename))
            : "<" == t
            ? cont(pushlex(">"), commasep(typeparam, ">"), poplex)
            : void 0
        }
        function funarg(e, t) {
          return (
                    ...
                    (function doctype(e) {
                      return function(t, n) {
                        for (var r; null != (r = t.next()); ) {
                          if ("<" == r)
                            return (
                              (n.tokenize = doctype(e + 1)), n.tokenize(t, n)
                            )
                          if (">" == r) {
                            if (1 == e) {
                              n.tokenize = inText
